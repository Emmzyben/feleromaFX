...
<footer class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            ...
            <div>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                    ...
                    <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Installing Feleroma bot</a>
                    <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Learning center</a>
                </div>
            </div>

            <div>
                <p class="font-semibold text-gray-800 dark:text-white">Additions</p>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                    ...
                    <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Book a Demo</a>
                    <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Download FX ebook</a>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between">
            <a href="#">
                <img  src="/cropped-logofx.png" alt="logo" width="100px"/>
            </a>
